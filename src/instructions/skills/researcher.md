...
```bash
omcc researcher -C <工作目录> "<研究任务描述>"

# 示例
omcc researcher -C /path/to/project "React useEffect 的最佳实践"
omcc researcher -C /path/to/project "TypeScript 5.5 有哪些新特性"
omcc researcher -C /path/to/project "为什么 Zod 报 ZodError: Invalid input"
```
...
Researcher 通过 Gemini CLI 配置的 MCP 提供网络研究能力：
